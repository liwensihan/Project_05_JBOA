	...
	<head>
		...
		<script type="text/javascript">
			...
			$("#AddRow").click(function(){		
				...
				tr.find("td").get(2).innerHTML="<input  name=detailList["+j+"].des  id=desc"+j+" type=hidden value="+des+" />"+des;
		...
		var totalAccount = <s:property value="claimvoucher.total_account"/>;
		function delRow(id){	
			...
			<input type="hidden" id="claimId" name="claimvoucher.id" value="<s:property value="claimvoucher.id"/>"/>
				<table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
                  ...
                  <tr>
                    ...
                    <td>填&nbsp;写&nbsp;人：<s:property value="claimvoucher.create.name"/></td>
                    <td>部&nbsp;&nbsp;门：<s:property value="claimvoucher.create.sysDepartment.name"/></td>
                    <td>职&nbsp;&nbsp;&nbsp;&nbsp;位：<s:property value="claimvoucher.create.sysRole.role_name"/></td>
                  </tr>
                  <tr>
                    <td>总金额：
                    <s:textfield name="claimvoucher.total_account" id="totalAccount" readonly="true"/></td>
                    <td>填报时间：<s:date name="claimvoucher.create_time" format="yyyy-MM-dd HH:mm:ss"/></td>
                    <td>状态：<s:property value="claimvoucher.status"/></td>
                    <td>待处理人：<s:property value="claimvoucher.next_deal.name"/></td>
				...
				<table id="myTable" width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					...
					<tr>
						...
						<td>
							<s:hidden id="desc%{#s.index}" name="detailList[%{#s.index}].des" value="%{#claimDetail.des}"/>
